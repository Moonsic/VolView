const option = {
  'BASIC_OPTION': {
    tooltip: {
      ...
      borderColor: 'transparent', // 设置边框颜色为透明，去掉边框
    },
    legend: {
      data: [],
      icon: 'circle',
    ...
    series: [
      {
        ...
        itemStyle: {
          borderWidth: 0,
          // borderWidth: 3, //设置border的宽度有多大,必须同时设置borderColor
          borderColor: '#042775',
        },
        label: {
          show: false,
    ...
    tooltip: {
      ...
      formatter: params => {
        return params.seriesName + '</br>'
          ...
          + '数量：' + params.data.realValue + '</br>'
          + '占比：' + (params.data.realValue / params.data.valueTotal * 100).toFixed(2) + '%'
      }
    },
    legend: {
      icon: 'circle',
