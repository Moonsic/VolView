...
export const lightTheme: { [key: string]: string } = {
  ...
  'lineListColor': 'rgba(0, 0, 0, 0.5)', // lineList的竖线颜色
}

// 护眼主题
export const eyecareTheme: { [key: string]: string } = {
  'backgroundColor': '#f8f6ef', // 背景色
  'xAxis.axisLabel.color': '#564f45', // x轴刻度标签
  'yAxis.axisLabel.color': '#564f45', // y轴刻度标签
  'xAxis.splitLine.lineStyle.color': '#dedeee', // x轴分隔线
  'yAxis.splitLine.lineStyle.color': '#dedeee', // y轴分隔线
  'yAxis.axisLine.lineStyle.color': '#dedeee', // y轴坐标轴轴线
  'series.itemStyle.color': '#222', // 折线
  'red-mark-line': 'rgba(255,0,0,.4)', // 红色竖线，带透明度，不遮挡折线
  'red-mark-line-text': '#a00', // 红色竖线上的文字颜色
  'badColor': '#ccc', // 坏道颜色
  'sliderBorderColor': 'rgba(210, 219, 238, 0.8)', // 滑块边框颜色
...
export const darkTheme: { [key: string]: string } = {
  ...
  'lineListColor': 'rgba(255, 255, 255, 0.5)', // lineList的竖线颜色
}
...
// 图表主题色
export const customColorList: { [key: string]: any } = [
